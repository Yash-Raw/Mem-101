...
| # | Lesson | Stage | You will be able to |
|--:|---|---|---|
| 50 | [Sleep-Time Compute](curriculum/advanced/sleep-time-compute/index.md) | `evolve` | Do memory work between conversations, and know when it pays off. |
...
| # | Lesson | Stage | You will be able to |
|--:|---|---|---|
| 54 | [Memory Topologies](curriculum/advanced/memory-topologies/index.md) | `store` | Choose between private, shared, hierarchical, and blackboard memory. |
| 55 | [Provenance and Trust](curriculum/advanced/provenance-and-trust/index.md) | `govern` | Record who wrote a memory and decide whether to believe it. |
| 56 | [Cross-Agent Write Conflicts](curriculum/advanced/cross-agent-write-conflicts/index.md) | `evolve` | Arbitrate concurrent writes from multiple agents. |
...
| # | Lesson | Stage | You will be able to |
|--:|---|---|---|
| 58 | [From Facts to a User Model](curriculum/advanced/from-facts-to-a-user-model/index.md) | `evolve` | Assemble preferences, traits, and goals; separate stable from volatile. |
| 59 | [Behaviour as Memory](curriculum/advanced/implicit-signals/index.md) | `extract` | Learn from corrections, repetitions, and abandonment. |
| 60 | [Personalization Without Creepiness](curriculum/advanced/applying-the-model/index.md) | `assemble` | Apply the model with user-visible correction affordances. |
