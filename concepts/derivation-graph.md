...
**Used in:** [Deletion That Actually Deletes](../curriculum/advanced/deletion-that-actually-deletes/index.md) · [Invariants and Drift Detection](../curriculum/advanced/invariants-and-drift-detection/index.md) · [Memory Observability](../curriculum/advanced/memory-observability/index.md)
