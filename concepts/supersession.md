...
**Used in:** [Forgetting Under a Budget](../curriculum/intermediate/budgeted-forgetting/index.md) · [Hybrid Architecture](../curriculum/intermediate/hybrid-architecture/index.md) · [Scope, Then Rank](../curriculum/intermediate/scope-then-rank/index.md) · [Vector Stores for Data That Changes](../curriculum/intermediate/vector-stores-for-mutable-data/index.md) · [Why Forgetting Is a Feature](../curriculum/intermediate/why-forgetting-is-a-feature/index.md)
<!-- graph:end -->
